      ...
      [
        {
          ...
          password:
            '$2a$10$j1o6zGazJwsXGeqr0cf5dugAkleDKRK0MA0xTPfDdh3CiinjcOc/C', // 10 rounds
          status: true,
          role: 1,
        },
        {
          ...
          password:
            '$2a$10$/HLkPCjdSfLVL90LE4cfQug./4jjn5L6qsNWjEPYrDiLOQsSvw.v6',
          status: true,
          role: 1,
        },
        {
          ...
          password:
            '$2a$10$jvtUsp7tC61tbjLrO9xXsu6kYjSA8/aCgMtYFV.oWhAmXadZS3yrK',
          status: true,
          role: 2,
        },
        {
          ...
          password:
            '$2a$10$oeXfTGCl2MDQBoV6AbhLu.Psg9lKlNNZ8hCUpGWdRwC7zNcMkREBK',
          status: true,
          role: 2,
        },
        {
          ...
          password:
            '$2a$10$T0jZfDXeaFD9J.zcrcFOIuWBeVUG90ff14KiTgtSVT.wka8x1Ma9K',
          status: true,
          role: 2,
        },
        {
          ...
          password:
            '$2a$10$jwJR6x00mo3g6cO5YbHRf.BMHcB8ePelGKNJyQAxilDPI5qcerewG',
          status: true,
          role: 2,
        },
      ],
